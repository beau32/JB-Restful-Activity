	...
	// "config.js.save.uri" as a POST
        ...
        if (hasInArguments){
        	values = payload['arguments'].execute.inArguments.filter(function( obj ) {
				return obj.hasOwnProperty('call_url') || obj.hasOwnProperty('call_body') || obj.hasOwnProperty('call_retry' || obj.hasOwnProperty('cauth_url') || obj.hasOwnProperty('auth_id') || obj.hasOwnProperty('auth_secret'));
			});
        }
